...
const navLinks = [
    ...
    { label: 'Projects',     routeName: 'admin.projects',     href: () => '#',                         icon: `<path d="M3 11 12 4l9 7"/><path d="M5 10v10h14V10"/><path d="M9 20v-5h6v5"/>` },
    { label: 'Units',        routeName: 'admin.units',        href: () => '#',                         icon: `<rect x="3" y="8" width="8" height="13" rx="1.5"/><rect x="13" y="3" width="8" height="18" rx="1.5"/>` },
    { label: 'Clients',      routeName: 'admin.clients',      href: () => '#',                         icon: `<circle cx="9" cy="7" r="4"/><path d="M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><path d="M19 8v6M22 11h-6"/>` },
    { label: 'Bookings',     routeName: 'admin.bookings',     href: () => '#',                         icon: `<rect x="3" y="4.5" width="18" height="16.5" rx="2.5"/><path d="M3 9h18M8 2.5v4M16 2.5v4"/><path d="m9 14 2 2 4-4"/>` },
    { label: 'Payments',     routeName: 'admin.payments',     href: () => '#',                         icon: `<rect x="2.5" y="5" width="19" height="14" rx="2.5"/><path d="M2.5 9.5h19"/>` },
    { label: 'Construction', routeName: 'admin.construction', href: () => '#',                         icon: `<path d="M2 20h20"/><path d="M6 20V10l6-7 6 7v10"/><path d="M10 20v-5h4v5"/>` },
    { label: 'Documents',    routeName: 'admin.documents',    href: () => '#',                         icon: `<path d="M6 3h8l4 4v14H6z"/><path d="M14 3v4h4"/><path d="M9 13h6M9 16.5h6"/>` },
];
    ...
    " style="width:260px; padding:20px 14px;">
        ...
        <nav class="flex flex-col gap-0.5 flex-1 overflow-y-auto min-h-0" style="scrollbar-width:none;">
            ...
            >
                ...
                <span
                    ...
                    class="ml-auto h-1.5 w-1.5 rounded-full bg-admin-accent"
                />
            </Link>
        </nav>
        ...
        <div class="relative">
            ...
            >
                <div
                    v-if="profileOpen"
                    class="absolute bottom-full mb-2 left-0 right-0 rounded-xl border py-1.5 z-50
                ...
                >
                    ...
                    <a
                        ...
                        :key="item.label"
                        :href="item.href"
                        class="flex items-center gap-2.5 px-3 py-2 text-sm text-slate-600 dark:text-slate-400 transition-colors hover:bg-slate-50 dark:hover:bg-white/[0.05]"
                    >
